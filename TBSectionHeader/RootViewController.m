...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section{
    ...
    int numOfObjects = [sectionInfo numberOfObjects] ;

    if(numOfObjects > 0)
        h = 30.0;
    
    NSLog(@"height for header = %f , object count : %d",h, numOfObjects);
...
//    CGRect rect = [tableView rectForHeaderInSection:section];
    ...
    if( [sectionInfo numberOfObjects] > 0){
        ...
        CGRect frame = CGRectMake(0, 0, self.tableView.frame.size.width, 30.0);
        
        //header = [[[MyHeader alloc] init] autorelease];
        header = [[[UILabel alloc] initWithFrame:frame] autorelease];
...
- (void)insertNewObject:(id)sender
{
    ...
    // Create instances of the entity managed by the fetched results controller.
    NSManagedObjectContext *context = [fetchedResultsController managedObjectContext];
    ...
    // Save the context with the newly created objects
    NSError *error = nil;
    if (![context save:&error]) {
        /*
         Replace this implementation with code to handle the error appropriately.
...
//    [self.tableView selectRowAtIndexPath:insertionPath animated:YES scrollPosition:UITableViewScrollPositionNone];
    ...
    /// This reload Causes the Header to come !!!
    //[self.tableView reloadRowsAtIndexPaths:[NSArray arrayWithObject:insertionPath] withRowAnimation:UITableViewRowAnimationFade];
}
...
- (void)deleteSelectedObject{
    ...
    if (currentSelection != nil) {
        ...
        id object = [fetchedResultsController objectAtIndexPath:currentSelection];
    ...
    if([sectionInfo numberOfObjects]){
        ...
        id nextObject = [fetchedResultsController objectAtIndexPath:nextIndex];
        detailViewController.detailItem = nextObject;
    }
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    */
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Create" inManagedObjectContext:managedObjectContext];
